...
# 1 "level2.h" 1
# 21 "level2.h"
extern const unsigned short level2Tiles[16384];
...
void drawHealth2() {
        ...
        shadowOAM[18].attr0 = iceHealth1.row| (0<<14) | (0<<13);
        shadowOAM[18].attr1 = iceHealth1.col | (2<<14);
        shadowOAM[18].attr2 = ((0)<<12)| ((iceHealth1.curFrame)*32+(iceHealth1.aniState));

}
void drawCream1() {
    for (int i = 0; i < 20; i++) {
    if (iceCream1[i].hide) {
        shadowOAM[i + 25].attr0 = (2<<8);
    } else {

        shadowOAM[i + 25].attr0 = iceCream1[i].row| (0<<14) | (0<<13);
        shadowOAM[i + 25].attr1 = iceCream1[i].col | (1<<14);
        shadowOAM[i + 25].attr2 = ((0)<<12)| ((iceCream1[i].curFrame)*32+(iceCream1[i].aniState));
    }
    }
}
void drawPlayer1() {
    if (iceman1.hide) {
        ...
        shadowOAM[47].attr0 = iceman1.row| (0<<14) | (0<<13);
        shadowOAM[47].attr1 = iceman1.col | (2<<14);
        shadowOAM[47].attr2 = ((0)<<12)| ((iceman1.curFrame)*32+(iceman1.aniState));
    }
...
void drawLives() {
    ...
    if (lives[i].hide) {
        ...
        shadowOAM[i + 60].attr0 = lives[i].row| (0<<14) | (0<<13);
        shadowOAM[i + 60].attr1 = lives[i].col | (1<<14);
        shadowOAM[i + 60].attr2 = ((0)<<12)| ((lives[i].curFrame)*32+(lives[i].aniState));
    }}
}
        ...
        if (!iceCream1[i].hide) {
            ...
            if ( iceman1.aniState == 4 && collision(iceCream1[i].col, iceCream1[i].row, iceCream1[i].width, iceCream1[i].height,
                iceman1.col, iceman1.row + 19, 9, 4)) {
                    ...
                    iceCream1[i].row = 0;
                      iceCream1[i].col = rand() % 200;
                    playSoundB(yumm, 6264 - 300, 11025, 0);
