...
void drawBoard() {
        ...
        shadowOAM[30].attr0 = iceBoard.row| (1<<14) | (1<<12) ;
        shadowOAM[30].attr1 = iceBoard.col | (3<<14);
        shadowOAM[30].attr2 = ((0)<<12)| ((iceBoard.curFrame)*32+(iceBoard.aniState));
}
void updateBoard() {
...
void updatePlayerWalk() {
    if ((icemanWalk.col >>3)< 240 - icemanWalk.width) {
...
void drawPlayerWalk() {
        ...
        shadowOAM[21].attr0 = icemanWalk.row| (0<<14) | (0<<13);
        shadowOAM[21].attr1 = icemanWalk.col >>3 | (2<<14);
        shadowOAM[21].attr2 = ((0)<<12)| ((icemanWalk.curFrame)*32+(icemanWalk.aniState));
    }
}
